...
const PillNav: React.FC<PillNavProps> = ({
  ...
  return (
    <div className="fixed top-0 left-0 z-[1000] w-full py-4">
      ...
      >
        <div className="flex items-center justify-between">
          ...
          <button
            ...
            className="md:hidden rounded-full border-0 flex flex-col items-center justify-center gap-1 cursor-pointer p-0 relative z-20"
            style={{
              width: "var(--nav-h)",
              height: "var(--nav-h)",
              background: "var(--base, #000)",
      ...
      <div
        ref={mobileMenuRef}
        className="md:hidden absolute top-[4em] left-6 right-6 rounded-[27px] shadow-[0_8px_32px_rgba(0,0,0,0.12)] z-[998] origin-top"
        style={{
          ...cssVars,
