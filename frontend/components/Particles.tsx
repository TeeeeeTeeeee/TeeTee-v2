...
const Particles: React.FC<ParticlesProps> = ({
  ...
  useEffect(() => {
    ...
    const handleMouseMove = (e: MouseEvent) => {
      ...
      // Calculate position even if mouse is outside container
    ...
    if (moveParticlesOnHover) {
      // Add to document instead of container for better tracking
  ...
  return (
    <div
      ...
      // Always auto since we're now using document-level events
